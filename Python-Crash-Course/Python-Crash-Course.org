...
#+BEGIN_SRC python :tangle random_walk.py
...
#+RESULTS:
:results:
[[file:./obipy-resources/CIefMs.png]]
:end:
...
#+RESULTS:
:results:
[[file:./obipy-resources/RHPbpD.png]]
:end:
...
#+RESULTS:
:results:
[[file:./obipy-resources/tEiurX.png]]
:end:
...
#+RESULTS:
:results:
[[file:./obipy-resources/WCaqmi.png]]
:end:
...
#+BEGIN_SRC python :session :results value pp
  ...
  numbers = [i+j for i in range(1, 7) for j in range(1, 7)]
  Counter(numbers)
#+END_SRC
...
#+BEGIN_SRC python :session :results value pp :tangle die.py
  from random import randint
...
#+RESULTS:
: [2, 5, 3, 2, 2, 3, 5, 6, 6, 1, 5, 1, 6, 4, 2, 2, 1, 3, 3, 4, 5, 1, 1, 2, 1, 3, 2, 6, 2, 1, 5, 4, 6, 5, 4, 2, 6, 6, 3, 3, 2, 2, 1, 6, 2, 4, 1, 4, 4, 6, 3, 4, 3, 5, 6, 1, 5, 2, 6, 4, 4, 2, 5, 6, 4, 6, 2, 5, 2, 4, 4, 4, 3, 3, 1, 4, 2, 3, 2, 4, 3, 4, 2, 1, 6, 5, 6, 5, 5, 4, 6, 3, 1, 5, 6, 2, 2, 6, 3, 3]
...
#+BEGIN_SRC python
  ...
  hist.title = "Results of rolling two D6 dice 1000 timess"
